                       ...
                       <form class="login-form" method="POST" action="controlador/modificar_car.php">
                           ...
                           while($datos = $sql->fetch_object()) { ?>
                               <div class="row">
                                   ...
                                   <div class="col-lg-12 mt-2">
                                       <input type="text" class="form-control" placeholder="Ingrese estado del vehículo" name="estado" value="<?= $datos->estado ?>">
                                   </div>
                                   <div class="col-lg-12 mt-2">
                           ...
                           <div class="text-center">
                               <p class="mb-0 mt-2 text-center">
                                   <a href="http://localhost/FCC/Capsone/Hola_mundo/vehiculo.php" class="text-dark fw-bold">Regresar</a>
                               </p>
                           </div>
                       </form>
                   </div>
