            ...
            <div class="home-desc-center">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
                            <div>
                                <h1 class="text-white home-title mb-0",>Vehiculos con alta disposición</h1>
                                <div class="mt-4">
                                    <a href="#" class="btn btn-outline-white">Solicitar Vehiculos</a>
                                </div>
                                <div class="mt-4">
                                    <a href="http://localhost/FCC/Capsone/Hola_mundo/vehiculo.php" class="btn btn-outline-white ">Datos de Vehiculos</a>
                                </div>
                                <div class="mt-4">
                                    <a href="/modelo/vehiculos.php" class="btn btn-outline-white ">Modificar info</a>
                                </div>
                            </div>
                        </div><!-- end col -->
                    </div><!-- end row -->
                ...
                <div class="col-md-4">
                    <div class="services-box">
                        ...
                        <div class="mt-3">
                            ...
                            <p class="services-subtitle text-muted"> Rpida modificacion de los datos de los vehiculares</p>
                        </div>
                    </div>
                </div>
                <!-- end col -->
